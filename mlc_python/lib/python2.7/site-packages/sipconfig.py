...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    '/opt/mlc-python-2.7.11/bin/../bin',
    'default_mod_dir':    '/opt/mlc-python-2.7.11/lib/python2.7/site-packages',
    'default_sip_dir':    '/opt/mlc-python-2.7.11/bin/../share/sip',
    'deployment_target':  '',
    'platform':           'linux-g++',
    'py_conf_inc_dir':    '/opt/mlc-python-2.7.11/include/python2.7',
    'py_inc_dir':         '/opt/mlc-python-2.7.11/include/python2.7',
    'py_lib_dir':         '/opt/mlc-python-2.7.11/lib/python2.7/config',
    'py_version':         0x02070b,
    'qt_framework':       0,
    'sip_bin':            '/opt/mlc-python-2.7.11/bin/../bin/sip',
    'sip_config_args':    '',
    'sip_inc_dir':        '/opt/mlc-python-2.7.11/bin/../include/python2.7',
    'sip_mod_dir':        '/opt/mlc-python-2.7.11/lib/python2.7/site-packages',
